...
ADMIN_USERNAME = "lhy"
ADMIN_PASSWORD = (
    "pbkdf2_sha256$120000$9SEp9OZWB5Ya$TVY41qkSk2g5WsPuXXYmYtCh1NwFO5ckJFIyMV8Yi4E="
)
...
ADMIN_REORDER = (
    # 공지
    {
        "app": "notice",
        "label": "공지사항",
        "models": ("notice.Notice", "notice.Attendance",),
    },
    # 사용자
    {
        "app": "members",
    ...
    # 기수, 팀
    {
        "app": "members",
        "label": "기수 & 팀",
        "models": ("members.Period", "members.Team",),
    },
    # 이벤트(LOL)
...
LOGGING = {
    ...
    "loggers": {
        ...
        "signal": {"handlers": ["signal", "console"], "level": "DEBUG",},
