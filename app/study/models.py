...
class Study(TimeStampedMixin):
    ...
    members = models.ManyToManyField(
        settings.AUTH_USER_MODEL, verbose_name='스터디원 목록', blank=True,
        through='StudyMembership', related_name='study_set', related_query_name='study',
    )
...
class StudyMeetingUserActivity(models.Model):
    ...
    meeting = models.ForeignKey(
        StudyMeeting, verbose_name='스터디 모임', on_delete=models.PROTECT,
        related_name='meeting_user_activity_set', related_query_name='meeting_user_activity',
    )
...
class StudyMeetingFine(models.Model):
    ...
    category = models.ForeignKey(
        StudyMeetingFineCategory, verbose_name='카테고리', on_delete=models.PROTECT,
        related_name='fine_set', related_query_name='fine',
    )
