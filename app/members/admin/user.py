...
class UserAdminProxyAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {"classes": ("wide",), "fields": ("name", "phone_number", "email",)}),
    )
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        fieldsets = (
            ...
            (
                "개인정보",
                {"fields": ("name", "email", "phone_number", "birth_date", "github",)},
            ),
            (
                "권한",
                {
                    ...
                    else ("is_active", "is_staff", "groups",)
                },
            ),
            ("주요 기록", {"fields": ("last_login", "date_joined",)}),
        )
        return fieldsets
